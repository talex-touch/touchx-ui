import{_ as n,o as a,c as e,O as l}from"./chunks/framework.930f5ddd.js";const u=JSON.parse('{"title":"开发攻略","description":"","frontmatter":{},"headers":[],"relativePath":"guide/go.md","filePath":"guide/go.md"}'),p={name:"guide/go.md"};function t(o,s,c,i,r,d){return a(),e("div",null,s[0]||(s[0]=[l(`<h1 id="开发攻略" tabindex="-1">开发攻略 <a class="header-anchor" href="#开发攻略" aria-label="Permalink to &quot;开发攻略&quot;">​</a></h1><h3 id="_1、修改环境变量" tabindex="-1">1、修改环境变量 <a class="header-anchor" href="#_1、修改环境变量" aria-label="Permalink to &quot;1、修改环境变量&quot;">​</a></h3><p><code>./.env</code>文件下</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;"># CSS预处理器 默认支持sass和less</span></span>
